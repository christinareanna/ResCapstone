...
function ReservationForm() {
  ...
  // TODO
  // reformat so catch works, says process error when it's not commented out. 
  // Links for seat and edit need to be a href. Got it working but not in the correct format. 
  // All tests pass. Cancel reservation and submitting new res works.
  // Fixed being able to see reservations for each date. Reservations was undefined. 
